...
const ERROR_CODE_MESSAGES = Object.freeze({
  ...
  INVALID_UPLOAD_INTENT_ID: () => 'Identificativo della prenotazione di upload non valido.',
  PHOTO_UPLOAD_INTENT_NOT_FOUND: () => 'La prenotazione dell’upload non esiste più. Ripeti il caricamento.',
  PHOTO_UPLOAD_INTENT_EXPIRED: () => 'La prenotazione dell’upload è scaduta. Ripeti il caricamento.',
  PHOTO_UPLOAD_INTENT_MISMATCH: () => 'La prenotazione non corrisponde al file selezionato. Ripeti il caricamento.',
  PHOTO_UPLOAD_REPLAY_MISMATCH: () => 'La stessa prenotazione è stata riutilizzata con dati differenti. Ripeti il caricamento.',
  PHOTO_UPLOAD_INTENT_STALE: () => 'La prenotazione dell’upload non è più attiva. Ricarica l’archivio.',
  PHOTO_UPLOAD_ALREADY_COMPLETED: () => 'Questa prenotazione ha già creato la foto. Aggiorna l’archivio.',
  PHOTO_UPLOAD_RESULT_GONE: () => 'La foto associata a questo upload è stata eliminata e non può essere ricreata dal replay.',
  PHOTO_UPLOAD_LEASE_LOST: () => 'Un’altra richiesta ha preso in carico questo upload. Attendi e aggiorna l’archivio.',
  PHOTO_CREATE_IN_PROGRESS: () => 'La foto è già in fase di elaborazione. Attendi qualche secondo e aggiorna l’archivio.',
  TRANSACTIONAL_PHOTO_CREATION_REQUIRED: () => 'Il caricamento richiede la persistenza Postgres transazionale.',
